...
with Search_cont:
    ...
    Photophysical_properties["Emission properties: Configuration Coordinate (amu$^{1/2}$ \AA)"] = Photophysical_properties["Emission properties: Configuration Coordinate (amu$^{1/2}$ \AA)"].map("{:.2E}".format)
