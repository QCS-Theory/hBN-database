        ...
        if spin_multiplicity == 'singlet'or spin_multiplicity == 'doublet':
            ...
            with col3:
                with st.container(border=True):
                    ...
                    ep2.rename(columns={"dipole_x":"µₓ (Debye)","dipole_y":"μᵧ (Debye)","dipole_z":"µz (Debye)","Intensity":"Intensity (Debye)","Angle of emission dipole wrt the crystal axis":"Angle of emission dipole wrt the crystal axis (degree)"},inplace=True)
                    ep2=ep2.T
                    jj =1
                    newheadcol =[]
                    ...
                    emp.rename(columns={"dipole_x":"µₓ (Debye)","dipole_y":"μᵧ (Debye)","dipole_z":"µz (Debye)","Intensity":"Intensity (Debye)"},inplace=True)
                    emp=emp.T
                    jj =1
                    newheadcol =[]
                    #latppdefects.iloc[1,0].replace("$","")
            ...
            with col3:
                with st.container(border=True):
                    ...
                    try: 
                        ...
                        ppdefects = Photophysical_properties[Photophysical_properties['Defect'] == str_defect]
                    ep2=ppdefects.iloc[:,3:]
                    ep2.rename(columns={"dipole_x":"µₓ (Debye)","dipole_y":"μᵧ (Debye)","dipole_z":"µz (Debye)"},inplace=True)
                    ep2=ep2.T
                    jj =1
                    newheadcol =[]
                    #latppdefects.iloc[1,0].replace("$","")
                    ...
                    try: 
                        ...
                        ppdefects = Photophysical_properties[Photophysical_properties['Defect'] == str_defect]
                    emp=ppdefects.iloc[:,3:]
                    emp.rename(columns={"dipole_x":"µₓ (Debye)","dipole_y":"μᵧ (Debye)","dipole_z":"µz (Debye)"},inplace=True)
                    emp=emp.T
                    jj =1
                    newheadcol =[]
                    #latppdefects.iloc[1,0].replace("$","")
