...
# Define the path to the OUTCAR_transition file for extracting NBANDS
outcar_transition_path = "OUTCAR_transition"  # Update this path as needed
...
NBANDS = extract_nbands(outcar_transition_path)
print(f"Extracted NBANDS: {NBANDS}")  # Optional: For debugging purposes
...
# Add annotations for "Triplet" centered between the two xcor positions (Optional)
# fig.add_trace(go.Scatter(
#     x=[0.7, 0.7],
#     y=[eemax - 1, eemax - 1],
#     text=["Triplet"],
